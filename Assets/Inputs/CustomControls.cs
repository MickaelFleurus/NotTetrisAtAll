...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/CustomControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CustomControls: IInputActionCollection2, IDisposable
{
    ...
    ~@CustomControls()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, CustomControls.Player.Disable() has not been called.");
    }
